  ...
  >
    <div class="fr-header__body">
          ...
          <div class="fr-header__brand fr-enlarge-link">
            ...
            <div class="fr-header__service">
              ...
              <p class="fr-header__service-tagline">
                Parcellaire cultivé en Agriculture Biologique
              </p>
            </div>
          </div>

          <div
            class="fr-hidden fr-unhidden-lg fr-header__tools"
            :data-numero-bio="user.numeroBio"
          >
            <div class="fr-header__tools-links">
              ...
              >
                ...
                >
                  <router-link
                    :to="rolePage"
                    :class="['fr-btn', 'fr-icon--sm', 'fr-mr-1w', roleIcon]"
                  >
                    {{ user.nom }}
                  </router-link>
                </li>
                <li class="tool-logout">
                  ...
                  >
                    <a
                      :href="href"
                      class="fr-btn fr-icon--sm fr-icon-logout-box-r-line"
      ...
      <div
        ...
        v-if="isLogged && permissions.isOc"
      >
        <div class="fr-container">
          <nav
            class="fr-nav"
      ...
      <div
        class="fr-header__menu"
        v-else-if="(isLogged && permissions.isAgri)"
      >
        <div class="fr-container">
          <nav
            class="fr-nav"
      ...
      <div class="fr-container">
        <div class="fr-notice__body">
          <p class="fr-notice__title">
            ...
            <a
              href="https://cartobio.agencebio.org"
