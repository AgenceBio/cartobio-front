...
describe("ActionType", () => {
  ...
  it("renders Parcellaire importé for all", async () => {
    ...
    wrapper = mount(ActionType, { props: { type: EventType.CERTIFICATION_STATE_CHANGE, 'state': CertificationState.OPERATOR_DRAFT } })
    expect(wrapper.text()).toContain("Parcellaire importé")
  })
  ...
  it("renders Certification en cours for Agri, and Audit terminé for OC", async () => {
    ...
    wrapper = mount(ActionType, { props: { type: EventType.CERTIFICATION_STATE_CHANGE, 'state': CertificationState.AUDITED } })
  ...
  it("renders Certification en cours for all", async () => {
    ...
    wrapper = mount(ActionType, { props: { type: EventType.CERTIFICATION_STATE_CHANGE, 'state': CertificationState.PENDING_CERTIFICATION } })
    expect(wrapper.text()).toContain("Certification en cours")
  })
  ...
  it("renders Certifié for all", async () => {
    ...
    wrapper = mount(ActionType, { props: { type: EventType.CERTIFICATION_STATE_CHANGE, 'state': CertificationState.CERTIFIED } })
    expect(wrapper.text()).toContain("Certifié")
  })
})
