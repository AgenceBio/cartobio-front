<template>
  ...
  >
    <legend
      class="fr-segmented__legend fr-sr-only"
      id="viewmode-switcher-heading"
      aria-label="Choix de l'onglet affiché"
    >
      Choix de l'onglet affiché
    </legend>
