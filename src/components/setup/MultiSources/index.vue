<template>
  <div class="fr-tabs">
    <p>
      Sélectionner l'outil informatisé qui est au plus proche de la réalité de votre terrain. Vous pourrez modifier
      manuellement votre parcellaire après l'import.
    </p>
    ...
    <ul class="fr-tabs__list" role="tablist">
      <li v-for="(source, sourceId) in sourcesTabs" role="presentation" :key="sourceId">
        <button
          class="fr-tabs__tab"
          :class="{ [`import-source-tab--${sourceId}`]: true }"
    ...
    <Component
      ...
      role="tabpanel"
      :id="`import-source--${featureSource}`"
      tabindex="0"
    />
  </div>
</template>
...
import featureSources, { DEFAULT_SOURCE } from "@/components/setup/MultiSources/sources/index.js";
