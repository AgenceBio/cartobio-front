    ...
    <form @submit.prevent="handleSubmit" role="search" id="import-geofolia-form" v-if="isStaging">
      ...
      <div class="fr-alert fr-alert--info" v-if="!canImportFromCloud">
        ...
        <p>
          Consultez la page
          <a
            href="https://docs-cartobio.agencebio.org/agriculteurs.trices/pas-a-pas/importer-mon-parcellaire/import-du-fichier-geofolia"
            target="_blank"
            >Import Geofolia<lien-externe
          /></a>
...
import {
  convertGeofoliaArchiveToGeoJSON,
  checkGeofoliaAccountStatus,
  getOperatorGeofoliaFeatures,
