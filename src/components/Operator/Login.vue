<template>
  <div>
    ...
    <form
      ...
      class="fr-search-bar fr-search-bar--lg fr-col-lg-8"
      id="header-search"
      role="search"
    >
      <label
        class="fr-label"
        for="search-784-input"
      >
        Recherche
      </label>
      <input
        class="fr-input"
        placeholder="Votre SIRET ou nom d'exploitation"
        v-model="userLogin"
        ref="loginInput"
        required
    ...
    <p
      v-if="hasCandidateUsers"
      class="fr-my-3w"
    >
      <button
        class="fr-link fr-icon-close-circle-line"
        @click="resetSearch"
      >
    ...
    <div
      class="fr-alert fr-alert--info fr-mt-2w fr-mb-2w fr-alert--waiting"
      v-if="isLoading"
      role="alert"
    >
            ...
            <div class="fr-card__content">
              ...
              <div class="fr-card__desc">
                <ul class="list-unstyled">
                  <li v-if="candidateUser.commune">
                    <strong>Siège</strong> : {{ candidateUser.commune }} ({{ candidateUser.departement }})
                  </li>
                  <li v-if="candidateUser.denominationCourante && candidateUser.denominationCourante !== candidateUser.nom">
                    <b>Dénomination courante</b> : {{ candidateUser.denominationCourante }}
                  </li>
                  <li v-if="candidateUser.siret">
                    <b>SIRET</b> : {{ candidateUser.siret }}
                  </li>
                  <li v-if="candidateUser.numeroPacage">
                    <b>PACAGE</b> : {{ candidateUser.numeroPacage }}
                  </li>
              ...
              <div class="fr-card__start">
                <ul class="fr-tags-group">
                  <li>
                    <p class="fr-badge fr-badge--success fr-icon-medal-fill">
                      vérifié
                    </p>
                  </li>
                </ul>
            ...
            <div class="fr-card__footer">
              <ul class="fr-btns-group  fr-btns-group--inline-lg">
                <li>
                  <button
                    class="fr-btn"
                    @click.prevent="loginCandidateUser(candidateUser)"
                  >
