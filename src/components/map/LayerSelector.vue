...
.menu-toggle--satellite {
  background: linear-gradient(180deg, rgba(0, 0, 0, 0) 21.88%, #000 89.58%), url(@/assets/map/plan.jpg) center / cover,
    lightgray 50% / contain no-repeat;
}

.menu-toggle--plan {
  background: linear-gradient(180deg, rgba(0, 0, 0, 0) 21.88%, #000 89.58%),
    url(@/assets/map/satellite.jpg) center / cover, lightgray 50% / contain no-repeat;
}
