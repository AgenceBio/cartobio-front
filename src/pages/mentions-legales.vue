  ...
  <div class="fr-container fr-my-5w">
    <div class="fr-row">
      <div class="fr-col-md-8">
        ...
        <p>
          La Plateforme CartoBio est éditée par l'Agence Bio située&nbsp;: 12, rue Henri Rol Tanguy, 93100 MONTREUIL
        </p>
        ...
        <p>Ce site est hébergé en propre par OVH : 2 rue Kellermann, 59100 Roubaix</p>
        ...
        <p>
          ...
          site, merci de nous en faire part. Si vous n’obtenez pas de réponse rapide de notre part, vous êtes en droit
        ...
        <p>
          ...
          <a href="https://www.agencebio.org/pied-de-page/contact/" target="_blank" rel="noopener"
            >formulaire de contact<lien-externe /></a
          >.
        </p>
        ...
        <p>
          Pour en savoir plus sur la politique d’accessibilité numérique de l’État :&nbsp;<a
            ...
            target="_blank"
            rel="nofollow"
            >https://accessibilite.numerique.gouv.fr/<lien-externe
          /></a>
        </p>
        <h2>Sécurité</h2>
        <p>
