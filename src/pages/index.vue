  ...
  <div class="fr-container fr-py-4w">
    <div class="fr-grid-row fr-grid-row--gutters">
      <div class="fr-col-lg-6 fr-col--center">
        <img
          src="../assets/illustrations/undraw_environment.svg"
          class="fr-responsive-img fr-my-3w cta-img"
          alt=""
        >
      ...
      <div class="fr-col-lg-6 fr-col--center">
        <img
          src="../assets/illustrations/undraw_certification.svg"
          class="fr-responsive-img fr-my-3w cta-img"
          alt=""
        >
