...
<template>
  <div class="fr-container fr-my-5w">
    ...
    <p>
      Cette déclaration d’accessibilité s’applique à <strong>CartoBio</strong><span>
        (<span>https://cartobio.agencebio.org</span>)</span>.
    </p>
    ...
    <p>
      ...
      >RGAA</abbr>. <span>Le site n’a encore pas été
        audité.</span>
    </p>
    ...
    <ul class="basic-information feedback h-card">
      ...
      <li>
        Formulaire de contact&nbsp;: <router-link
          to="/contact"
        >
          https://cartobio.agencebio.org/contact
        </router-link>
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        Contacter <a href="https://www.defenseurdesdroits.fr/saisir/delegues">le délégué du Défenseur des droits dans
          votre région</a>
      </li>
      <li>
    ...
    <p>
      ...
      >Générateur de Déclaration d’Accessibilité de
        BetaGouv</a>.
    </p>
  </div>
</template>
