...
import { AnnotationTags, LEVEL_AB, LEVEL_C1, LEVEL_C2, LEVEL_C3, LEVEL_MAYBE_AB, LEVEL_UNKNOWN } from "@/referentiels/ab.js";
      ...
      new Map([
        ...
        [
          RuleSet.CULTURE_MISSING,
          {
            ...
            select(f) {
              // l'id = 1 provient du dessin d'une parcelle en création et l'id = '__00000001__' provient d'une reférence cadastrale en cours de création
              if (!f.properties.isCertified && (f.id === 1 || f.id === "__00000001__")) return false;
        ...
        [
          RuleSet.ENGAGEMENT_DATE_MISSING,
          {
            ...
            select(f) {
              return (
                !f.properties.engagement_date && [LEVEL_C1, LEVEL_C2, LEVEL_C3,LEVEL_AB].includes(f.properties.conversion_niveau)
              );
            },
          },
        ],
