...
describe("results", () => {
  it("computes an introspection of the featureCollection as an operator", () => {
    ...
    expect(featuresSets.sets).toMatchObject(
      new Map([
        [
          RuleSet.NAMELESS,
          {
...
describe("byFeature()", () => {
  it("returns results tied to a featureId", () => {
    ...
    expect(featuresSets.byFeature("6")).toMatchObject(
      new Map([
        [
          RuleSet.CONVERSION_LEVEL_UNSURE,
          {
...
describe("byFeatureProperty()", () => {
  it("returns only the relevant property checks", () => {
    ...
    expect(featuresSets.byFeatureProperty("6", "conversion_niveau")).toMatchObject(
      new Map([
        [
          RuleSet.CONVERSION_LEVEL_UNSURE,
          {
...
describe("byFeatureDetail()", () => {
  it("returns only the relevant property checks", () => {
    ...
    expect(featuresSets.byFeatureDetail("2", 0)).toMatchObject(
      new Map([
        [
          RuleSet.CULTURE_UNSURE,
          {
