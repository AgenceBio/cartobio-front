...
function getSheet() {
  ...
  sheet["B1"].l = {
    Target: `https://annuaire.agencebio.org/fiche/${operator.numeroBio}`,
    Tooltip: `https://annuaire.agencebio.org/fiche/${operator.numeroBio}`,
  };
  sheet["B1"].t = "s";
  sheet["B2"].t = "d";
  ...
  sheet_add_aoa(
    ...
    this.getSortedFeatures().map((feature) => {
      ...
      const surfaceHa = (legalProjectionSurface(feature) / 10_000).toLocaleString("fr-FR", {
