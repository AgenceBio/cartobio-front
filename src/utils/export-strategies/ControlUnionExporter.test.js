...
describe("ControlUnionExporter", () => {
  test("list by features", () => {
    ...
    const expectation = [
      ...
      ["", "Luzerne", 0.753054443359375, new Date("2023-01-01T00:00:00.000Z"), "C1", "1.1 (nom personnalisé), Visitée", "1", "01.19.10.8"],
      ["", "Luzerne", 0.753054443359375, new Date("2023-01-01T00:00:00.000Z"), "C1", "1.2, Prélèvement effectué, À risque", "2", "01.19.10.8"],
      [
        "",
        "Luzerne",
        0.753054443359375,
      ...
      ["", "Trèfle", 0.753054443359375, new Date("2015-01-01T00:00:00.000Z"), "AB", "2.2, 4 feuilles, semis le 01/03/2023", "4", "01.19.10.7"],
      [
        "",
