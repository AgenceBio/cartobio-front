...
describe("ControlUnionExporter", () => {
  test("list by features", () => {
    ...
    const expectation = [
      ...
      ["", "Luzerne", 0.753054443359375, "01/01/2023", "C1", "1.1 (nom personnalisé), Visitée", "1", "01.19.10.8"],
      ["", "Luzerne", 0.753054443359375, "01/01/2023", "C1", "1.2, Prélèvement effectué, À risque", "2", "01.19.10.8"],
      [
        "",
        "Luzerne",
        0.753054443359375,
      ...
      ["", "Trèfle", 0.753054443359375, "01/01/2015", "AB", "2.2, 4 feuilles, semis le 01/03/2023", "4", "01.19.10.7"],
      [
        "",
